...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 932926027, ; hash 0x379b524b, from name: aot-CardioGuardMobile
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1654712445, ; hash 0x62a0e87d, from name: libaot-CardioGuardMobile
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CardioGuardMobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 173
	...
	%struct.DSOCacheEntry {
		i64 1789234378, ; hash 0x6aa58cca, from name: CardioGuardMobile
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CardioGuardMobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 189
	...
	%struct.DSOCacheEntry {
		i64 2099459349, ; hash 0x7d233515, from name: aot-CardioGuardMobile.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CardioGuardMobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 227
	...
	%struct.DSOCacheEntry {
		i64 2467702739, ; hash 0x931627d3, from name: libaot-CardioGuardMobile.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CardioGuardMobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 277
	...
	%struct.DSOCacheEntry {
		i64 3472655004, ; hash 0xcefc829c, from name: CardioGuardMobile.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CardioGuardMobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 394
