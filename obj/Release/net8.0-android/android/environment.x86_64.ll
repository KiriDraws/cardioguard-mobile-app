...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100670635, ; uint32_t jnienv_initialize_method_token (0x6001cab)
	i32 100670634, ; uint32_t jnienv_registerjninatives_method_token (0x6001caa)
...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 2621335342803693697, ; hash 0x2460da9b18fdb081, from name: aot-CardioGuardMobile.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CardioGuardMobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 65
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3518383702873464011, ; hash 0x30d3cf56294bdccb, from name: CardioGuardMobile.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CardioGuardMobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 89
	...
	%struct.DSOCacheEntry {
		i64 9128949531912216290, ; hash 0x7eb08b3b66189ee2, from name: libaot-CardioGuardMobile
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CardioGuardMobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 231
	...
	%struct.DSOCacheEntry {
		i64 10833419276348819798, ; hash 0x9658096f15a40956, from name: libaot-CardioGuardMobile.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CardioGuardMobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 271
	...
	%struct.DSOCacheEntry {
		i64 12009390835641141792, ; hash 0xa6a9ed562738ca20, from name: CardioGuardMobile
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CardioGuardMobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 307
	...
	%struct.DSOCacheEntry {
		i64 13491452962824118517, ; hash 0xbb3b44fd2905e0f5, from name: aot-CardioGuardMobile
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CardioGuardMobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 352
...
@.env.3 = private unnamed_addr constant [37 x i8] c"b0db83c7-fdba-4c0b-a5d7-19f1e9f4cb6f\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [34 x i8] c"com.companyname.cardioguardmobile\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [32 x i8] c"libaot-CardioGuardMobile.dll.so\00", align 16
